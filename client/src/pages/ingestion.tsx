  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold mb-2">Ingestion & Security</h1>
          <p className="text-muted-foreground">Process financial documents securely with automatic PII redaction.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2 card-simple">
            <CardHeader>
            ...
            <CardContent>
              <div className="border-2 border-dashed border-card-border hover:border-primary rounded-lg p-8 text-center cursor-pointer transition-colors mb-6">
                <UploadCloud className="w-10 h-10 mx-auto mb-2 text-muted-foreground" />
                <h3 className="font-bold mb-1">Drag Files Here</h3>
                <p className="text-sm text-muted-foreground">PDF, CSV, ZIP</p>
              </div>
